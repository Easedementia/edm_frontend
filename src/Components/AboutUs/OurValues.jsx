...
const valuesData = [
    {
        icon: "https://d2mzeyyrjif26w.cloudfront.net/assets/compressed-images/compassion_compressed-min.png",
        heading: 'Compassion',
        description: 'At Easedementia, empathy is our guiding principle, ensuring dignity and respect for all our clients.'
    },

    {
        icon: "https://d2mzeyyrjif26w.cloudfront.net/assets/compressed-images/progress_compressed-min.png",
        heading: 'Innovation',
    ...
    {
        icon: "https://d2mzeyyrjif26w.cloudfront.net/assets/compressed-images/accountability_compressed-min.png",
        heading: 'Accountability',
        description: 'Our team delivers compassionate, reliable care, treating every individual as cherished.'
    },

    {
        icon: "https://d2mzeyyrjif26w.cloudfront.net/assets/compressed-images/integrity_compressed-min.png",
        heading:'Integrity',
