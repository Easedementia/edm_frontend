...
const AssessmentOptions = () => {
  return (
    <OptionsContainer>
        <OptionCard>
            <OptionImage src="https://d2mzeyyrjif26w.cloudfront.net/assets/images/assessment_icon_compressed.png" alt='self-assessment' />
            ...
            <OptionLink to='/assessment/self-assessment-instructions'>
                Begin Assessment
                <img style={{width:'28px', height:'28px', marginLeft:'10px'}} src="https://d2mzeyyrjif26w.cloudfront.net/assets/images/arrow_compressed.png" alt="Arrow Icon" />
            </OptionLink>
        </OptionCard>

        <OptionCard>
            <OptionImage src="https://d2mzeyyrjif26w.cloudfront.net/assets/images/assessment_icon_compressed.png" alt='first-person' />
