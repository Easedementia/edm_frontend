            ...
            <ServiceContainer>
                {services.map((service, index) => (
                    <ServiceCard key={index}>
                        ...
                        Explore More
                        <img style={{width:'22px', height:'22px', marginLeft:'10px'}} src="https://d2mzeyyrjif26w.cloudfront.net/assets/compressed-images/arrow_compressed-min.png" alt="Arrow Icon" />
                        </ServiceLink>
                    </ServiceCard>
                ))}
            </ServiceContainer>
