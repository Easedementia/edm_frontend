...
const UserHomePage = () => {
  return (
    ...
    <Helmet>
        ...
        <meta name="keywords" content="Dementia care, Alzheimer’s support, Caregiver assistance, Memory loss treatment, Active Aging, Home based interventions, Kochi, Ernakulam, Thrissur, Kottayam, Kozhikode, Dementia" />
